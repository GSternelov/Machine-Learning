...
In 2.4 the classification of the costumers is performed with the Naive Bayes classifier. The first of the tables below gives the confusion matrix for training data and the second for test data. For training data the misclassification rate is `r (bayesTrain [2,1] + bayesTrain[1,2]) / sum(diag(bayesTrain))` and for test data it is `r (bayesTest [2,1] + bayesTest[1,2]) / sum(diag(bayesTest))`.  
